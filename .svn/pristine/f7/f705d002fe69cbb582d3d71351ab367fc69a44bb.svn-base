...
namespace Com.Winfotian.Service
{
    ...
    public class WinfoToolServiceRead : IWinfoToolServiceRead
    {
        ...
        public List<T_DTU> GetSiteByCompanyIdAndGroupCode(string activeKey, string companyId, string groupCode)
        {
            ...
            try
            {
                if (WcfCommon.LoginCheck(activeKey))
                {
                    if (!string.IsNullOrWhiteSpace(companyId) && !string.IsNullOrWhiteSpace(groupCode))
                        list = new UserDTUProvider().GetSiteByCompanyIdAndGroupCode(companyId, groupCode);
                }
            }
            catch (Exception ex)
            {
        ...
        public List<string> GetUserIdByDTUId(string ActiveKey, string DTUId)
        {
            ...
            try
            {
                ...
                {
                    list = new UserDTUProvider().GetUserIdByDTUId(DTUId);
                }
            }
            catch (Exception ex)
            {
        ...
        public List<T_DTU_FieldDesc> GetFiledListByDtuid(string ActiveKey,string Dtuid)
        {
            List<T_DTU_FieldDesc> list = new List<T_DTU_FieldDesc>();
            try
            {
                if (WcfCommon.LoginCheck(ActiveKey))
                {
                    list = new FieldProvider().GetAddOrUpdateFiledList(Dtuid);
                }
            }
            catch (Exception ex)
            {
        ...
        public List<T_DTU_GroupEx> GetSiteGroupByCompanyId(string activeKey, string companyId)
        {
            ...
            try
            {
                if (WcfCommon.LoginCheck(activeKey))
                {
                    list = new DtuGroupProvider().GetSiteGroupByCompanyId(companyId);
                }
            }
            catch (Exception ex)
            {
        ...
        public List<T_DTU_DataTransmit> GetTransVerList(string ActiveKey)
        {
            List<T_DTU_DataTransmit> list = null;
            try
            {
                if (WcfCommon.LoginCheck(ActiveKey))
                {
            ...
            if (list == null)
            {
                list = new List<T_DTU_DataTransmit>();
            }
            return list;
        }
        #endregion
        ...
        public bool IsGroupHasSite(string activeKey, string groupCode)
        {
            bool result = false;
            try
            {
                if (WcfCommon.LoginCheck(activeKey))
                {
                    result = new DtuGroupProvider().IsGroupHasSite(groupCode);
                }
            }
            catch (Exception ex)
            {
        ...
        public List<T_DTU_FieldDesc> GetFiledBySite(string activeKey, string siteId)
        {
            List<T_DTU_FieldDesc> list = new List<T_DTU_FieldDesc>();
            try
            {
                if (WcfCommon.LoginCheck(activeKey))
                {
                    list = new FieldProvider().GetFiledBySite(siteId);
                }
            }
            catch (Exception ex)
            {
