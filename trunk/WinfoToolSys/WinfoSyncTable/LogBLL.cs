...
namespace Com.Winfotian.DataProvider
{
    public class LogBLL
    {
        private static string SystemCode = "Winfo_Log001";
        /// <summary>
        /// 记录登陆日志
        /// </summary>
        ...
        public static void WriteLoginLog(string logFromIP, string userId, string pwd, int result)
        {
            try
            {
                ...
                ServiceProxy.LogService.T_Log model = new ServiceProxy.LogService.T_Log();
                model.businessSystem = SystemCode;
