var common = {
    treeNum: 1,                      //中间折叠的记数
    topNum: 1,                       //向上折叠的记数
    animate_ShowTree: function ()
    {    //有动画的折叠
        $("#meNav").animate({ "width": "160px", "left": "3px" }, 'normal');
        $("#meFold").animate({ "left": "166px" }, 'normal');
        $("#meContent").animate({ "width": $(window).width() - 175 + "px",
            "left": "172px"
        }, 'normal');
        $("#ifmContent").animate({ "width": $(window).width() - 175 + "px",
            "left": "172px"
        }, 'normal');
    },
    animate_hideTree: function ()
    {    //有动画的展开
    ...
    me_showTree: function ()
    { //无动画的折叠
        $("#meNav").css({ "width": "160px", "left": "3px" });
        $("#meFold").css({ "left": "166px" });
        $("#meContent").css({ "width": $(window).width() - 175 + "px",
            "left": "172px"
        });
        $("#ifmContent").css({ "width": $(window).width() - 175 + "px",
            "left": "172px"
        });
    },
    ...
    {
        window.top.common.setInfo({ "m_id": "infoMe",
            "m_content": msg
        });
    },
    //父页的提示层(要关闭)
    ...
    {
        $('.myBGTop').fadeTo("slow", 0).css("z-index",1);
        $('#WinTop').hide().css("z-index", 1);;
        $("#ifrHTMLTop").attr("src", "");
