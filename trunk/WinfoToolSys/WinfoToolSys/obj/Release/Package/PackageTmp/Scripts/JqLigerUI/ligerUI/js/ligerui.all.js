...
(function ($)
{
    ...
    //dialog 图片文件夹的路径 预加载
    l.DialogImagePath = "../skins/Aqua/images/win/";
...
(function ($)
{
    ...
    $.ligerui.controls.Layout.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            {
                g.top = $("> div[position=top]", g.layout).wrap('<div class="l-layout-topB" style="top:0px;height:173px; background-color:red"></div>').parent();
            ...
            {
                g.center = $("> div[position=center]", g.layout).wrap('<div class="l-layout-center"style="top:100px;" ></div>').parent();
